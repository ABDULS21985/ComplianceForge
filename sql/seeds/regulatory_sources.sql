...
-- UK
(gen_random_uuid(), 'ICO (Information Commissioner''s Office)', 'regulator', 'GB', 'UK', 'https://ico.org.uk', 'https://ico.org.uk/about-the-ico/news-and-events/news-and-blogs/rss/', '{UK_GDPR,CYBER_ESSENTIALS}', 'daily', true),
...
(gen_random_uuid(), 'FCA (Financial Conduct Authority)', 'regulator', 'GB', 'UK', 'https://www.fca.org.uk', NULL, '{PCI_DSS_4,UK_GDPR}', 'daily', true),
(gen_random_uuid(), 'PRA (Prudential Regulation Authority)', 'regulator', 'GB', 'UK', 'https://www.bankofengland.co.uk/prudential-regulation', NULL, '{NIST_800_53,ISO27001}', 'weekly', true),
...
(gen_random_uuid(), 'EDPB (European Data Protection Board)', 'regulator', NULL, 'EU', 'https://edpb.europa.eu', NULL, '{UK_GDPR}', 'daily', true),
...
(gen_random_uuid(), 'BfDI (Bundesbeauftragter für den Datenschutz)', 'regulator', 'DE', 'EU', 'https://www.bfdi.bund.de', NULL, '{UK_GDPR}', 'weekly', true),
...
(gen_random_uuid(), 'CNIL (Commission nationale de l''informatique et des libertés)', 'regulator', 'FR', 'EU', 'https://www.cnil.fr', 'https://www.cnil.fr/fr/rss.xml', '{UK_GDPR}', 'daily', true),
...
(gen_random_uuid(), 'AP (Autoriteit Persoonsgegevens)', 'regulator', 'NL', 'EU', 'https://autoriteitpersoonsgegevens.nl', NULL, '{UK_GDPR}', 'weekly', true),
...
(gen_random_uuid(), 'AEPD (Agencia Española de Protección de Datos)', 'regulator', 'ES', 'EU', 'https://www.aepd.es', NULL, '{UK_GDPR}', 'weekly', true),
...
-- Additional EU DPAs
(gen_random_uuid(), 'DPC Ireland (Data Protection Commission)', 'regulator', 'IE', 'EU', 'https://www.dataprotection.ie', NULL, '{UK_GDPR}', 'weekly', true),
(gen_random_uuid(), 'UODO Poland (Urząd Ochrony Danych Osobowych)', 'regulator', 'PL', 'EU', 'https://uodo.gov.pl', NULL, '{UK_GDPR}', 'weekly', true);
